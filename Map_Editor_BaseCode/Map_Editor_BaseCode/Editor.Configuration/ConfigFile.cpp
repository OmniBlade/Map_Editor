...
ConfigFile::ConfigFile(const std::string& id, const std::string& name, const std::string& path, const std::string& installDir, const std::string& game)
:ID(id), Name(name), Path(path), InstallDir(installDir)
{
	/*
		Is this ugly?
